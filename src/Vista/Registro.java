...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setBorder(javax.swing.BorderFactory.createTitledBorder("Dni:"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String nombre , apellidos , contraseña, usuario, dni;
        nombre = jTextField1.getText();
        apellidos = jTextField2.getText();
        contraseña = jTextField3.getText();
        usuario = jTextField4.getText();
        dni = jTextField5.getText();
        Administrador a = new Administrador(nombre, apellidos, contraseña, usuario, dni, 3 , "True");
        cad_administrador.crear(a);
